...
public class AudioSpeechTextView extends AppCompatTextView {
    public SpeechListener speechListener;
    public int maxMillis;
    private RectF rect;

    public AudioSpeechTextView(Context context) {
        this(context, null);
    }

    public AudioSpeechTextView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AudioSpeechTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
